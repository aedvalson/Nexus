		...
		tablesorterPager: new function() {
			...
			this.construct = function(settings) {
				...
				return this.each(function() {	
					...
					{
						setPageSize(table,parseInt(this.id.replace("rows", "")));
						return false;
					});
  ...
  $.extend({
    tablesorterFilter: new function() {
      ...
      function has_words(str, words, caseSensitive) {
		...
		{
			var text = "";
			$(node).children('.view').children('span').each( function() {
				text = text + $(this).html();
			});
        ...
        if(filterCount == 0) {
          ...
          var search_text = function() {
            ...
            for(var i=0; i < filterCount; i++) {
              if(! filters[i].filterFunction( myTextExtraction(filters[i].findStr ? elem.find(filters[i].findStr) : elem), filters[i].words, filters[i].caseSensitive)) {
